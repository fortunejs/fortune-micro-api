...
module.exports = {
  ...
  attachIncluded, parseBuffer, extractNamespace, capitalize
}
...
function showContext (options) {
  ...
  context[reservedKeys.vocabulary] = `${options.entryPoint}#`
