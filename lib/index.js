...
const baseContextField = reservedKeys.baseContext
  ...
  class MicroApiSerializer extends HttpSerializer {
    ...
    showIndex (contextResponse, request, response) {
      ...
      contextResponse.payload = {
        [baseContextField]: showContext(options),
        [typeField]: reservedKeys.ontology,
    ...
    showError (error) {
      ...
      error.payload = {
        [baseContextField]: showContext(this.options),
        [errorField]: errorObject
      }
    }
